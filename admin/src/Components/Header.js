...
<nav className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a className="navbar-brand brand-logo" href="/Header"><img src="images/Royal 2.jpeg" style={{width:'160px', height: '90px' , marginLeft: '-26px'}} alt="logo"/></a>
        <a className="navbar-brand brand-logo-mini" href="/Header"><img src="images/Royal 2.jpeg" alt="logo"/></a>
      </div>
